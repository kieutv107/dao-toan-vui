...
function home(){
  ...
  <aside class="disclaimer" aria-labelledby="disclaimer-title"><b id="disclaimer-title">Về dự án</b><p>Đảo Toán Vui là dự án cá nhân, phi lợi nhuận, do một người bố có con trai đang học tiểu học làm ra để giúp con học toán vui hơn. Ứng dụng được cung cấp nguyên trạng và không cam kết bất kỳ điều gì. Người dùng tự chịu trách nhiệm về mọi vấn đề có thể xảy ra khi sử dụng.</p></aside>`;
