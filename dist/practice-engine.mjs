...
export function createPractice({profile,sessionId,random=Math.random,now=Date.now(),record=()=>{}}={}){
  return {profile,sessionId,random,now,record,questions:buildPracticeSession({profile,sessionId,random,now}),pos:0,done:false,results:{correct:0,wrong:0,hints:0}};
}
